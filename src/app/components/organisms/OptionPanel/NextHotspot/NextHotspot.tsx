...
import useNextHotspot from '@showroom/hotspots/nextHotspot/useNextHotspot';
...
import { NextData } from '@src/app/showroom/hotspots/nextHotspot/nextHotspotData';
...
const NextHotspot: React.FC<Props> = ({ className }) => {
  ...
  const { setDataFromFields } = useNextHotspot(setFieldsFromData);
